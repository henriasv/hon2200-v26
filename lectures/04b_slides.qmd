...
np.random.seed(0)
np.random.random()  # Advance RNG state
...
Hva er omganger og hva er partisjoner her?

I denne tilpasningen har jeg brukt et polynom av grad 4. Hva skal vi gjøre for å beregne mean squared error for den et polynom av grad 4 med kryssvalidering med 5 omganger? Beskriv på figuren.
:::
...
:::{.notes}
Eksempel på kryssvalidering med k=5 omganger:
```plaintext
Omgang 1: Train on [2, 3, 4, 5], Test on [1]
Omgang 2: Train on [1, 3, 4, 5], Test on [2]
Omgang 3: Train on [1, 2, 4, 5], Test on [3]
Omgang 4: Train on [1, 2, 3, 5], Test on [4]
Omgang 5: Train on [1, 2, 3, 4], Test on [5]
```
:::
